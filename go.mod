...
require (
	...
	github.com/kubevirt/macvtap-cni v0.0.0-00010101000000-000000000000
...
require (
	...
	github.com/kubevirt/device-plugin-manager v1.19.5 // indirect
